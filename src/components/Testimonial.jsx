    ...
    <div className="bg-gray50 py-16">
      <div className="padX maxW w-full flex items-center justify-between">
        <div className="w-[43%] max-lg:w-[80%] max-md:w-full max-lg:mx-auto">
          ...
          <div className="flex items-center gap-x-0.5 text-warning400 py-10 max-md:py-8 max-sm:py-4">
            <IoIosStar />
            <IoIosStar />
            <IoIosStar />
            <IoIosStar />
          ...
          <div className="flex max-sm:flex-col max-sm:items-start gap-y-6 items-center justify-between pt-10 max-sm:pt-6 max-md:pt-8">
            <div className="flex items-center gap-x-3">
              ...
              <div className="flex flex-col gap-y-1.5">
                <span className="text-gray900 text-lg max-sm:text-base leading-none">
                  Sarah Thompson
                </span>
                <span className="text-gray600 font-inter400 max-sm:text-sm leading-none">
                  Project Manager, Shopify
                </span>
              </div>
            </div>
            <div className="flex items-center gap-x-8 max-sm:gap-x-4">
              <span className="bg-white rounded-full p-2 border border-gray300">
